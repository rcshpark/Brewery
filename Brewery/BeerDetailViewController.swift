...
class BeerDetailViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        tableView.register(UITableViewCell.self, forCellReuseIdentifier: "BeerDetailViewController")
        tableView.rowHeight = UITableView.automaticDimension
        
        let frame = CGRect(x: 0, y: 0, width: view.frame.height, height: 300)
...
extension BeerDetailViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = UITableViewCell(style: .default, reuseIdentifier: "BeerDetailViewController")
